        ...
        <div class="py-4 text-left px-6">
          ...
          <ul class="flex flex-wrap mb-4">
            <li class="flex-auto text-center">
              <a class="block rounded py-3 px-4 transition" @click.prevent="tag = 'login'" 
              :class="{'hover:text-white text-white bg-blue-600' : tab === 'login',
              'hover:text-blue-600' : tab === 'register'}" 
              href="#">Login</a>
            </li>
            <li class="flex-auto text-center">
              <a class="block rounded py-3 px-4 transition" @click.prevent="tab = 'register'"
          ...
          @submit="register" :initial-values="userData">
            ...
            <div class="mb-3">
              ...
              <vee-field type="email" name="email"
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                  duration-500 focus:outline-none focus:border-black rounded"
                placeholder="Enter Email" :validation-schema="schema" />
            ...
            <button type="submit" :disabled='reg_in_submision'
              class="block w-full bg-purple-600 text-white py-1.5 px-3 rounded transition
                hover:bg-purple-700">
              Submit
            </button>
  ...
  data(){
    return{
      ...
      schema:{
        ...
        country:"required|country_excluded:Hogwarts",
        tos:"tos"
      },
      userData:{
        country: 'USA',
